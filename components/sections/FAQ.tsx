...
const faqs = [
    {
        q: "本当に効果がありますか？効果がなかった場合は？",
        a: "初回の添削で「具体的にどこを直せばよいか」が明確になります。万が一、アドバイス内容にご納得いただけない場合は、初回全額返金保証を用意しております。"
    },
    {
        q: "他のオンラインレッスンと何が違うのですか？",
        a: "一般的なオンラインレッスンは「時間制」ですが、Melody LINEは「成果制」。あなたの演奏を何度でも見返せる楽譜添削と、LINEでいつでも質問できる環境で、24時間365日、あなたのペースで上達できます。"
    },
    {
        q: "続けられるか心配です…",
        a: "ご安心ください。月4回→週1回ペースなので、忙しい方でも無理なく続けられます。"
    },
    {
